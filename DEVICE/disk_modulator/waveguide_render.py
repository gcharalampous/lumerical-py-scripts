...
def waveguide_draw(device):
    ...
    ("metal_anode",(("x min", -disk_diameter/2 + offset_electrode),
                    ("x max", -disk_diameter/2 + metal_anode_width + offset_electrode),
    ...
    ("metal_cathode",(("x min", disk_diameter/2 - offset_electrode - metal_cathode_width),
