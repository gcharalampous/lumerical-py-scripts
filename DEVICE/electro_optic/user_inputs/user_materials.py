...
material_list_e = [oxide_material_e, wg_material_e, contact_material_e, background_material_e]
...
material_list_o = [oxide_material_o, wg_material_o, contact_material_o, background_material_o]
