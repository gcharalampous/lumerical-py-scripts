...
wg_radius_start = (
    4.50e-6  # Choose the start waveguide radius 'wg_radius_start' you want to start sweeping
)
wg_radius_stop = (
    10.0e-6  # Choose the stop waveguide radius 'wg_radius_stop' you  want to finish sweeping
)
