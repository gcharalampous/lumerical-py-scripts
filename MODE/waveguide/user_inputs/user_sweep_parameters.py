...
wg_width_start = 0.250e-6     # Choose the start waveguide width 'wg_width_start' 
#you want to start sweeping
wg_width_stop = 3.25e-6      # Choose the stop waveguide width 'wg_width_stop' you 
#want to finish sweeping
wg_width_step = 0.25e-6     # Choose the step of each sweep 'wg_width_step'
