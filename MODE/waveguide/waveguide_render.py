...
def waveguide_draw(mode):
    ...
    mode.setmaterial(
        p_material, {"Refractive Index": slab_index, "Imaginary Refractive Index": k_P}
    )
    ...
    mode.setmaterial(
        n_material, {"Refractive Index": slab_index, "Imaginary Refractive Index": k_N}
    )
    ...
    mode.setmaterial(
        silicon_np, "Base Material", "Si (Silicon) - Palik"
    )  # use "Silicon" model type
