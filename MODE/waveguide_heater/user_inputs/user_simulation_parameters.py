...
# 3.Metal Layer Dimensions
metal_width = [2.0e-6, 2.0e-6]
metal_thickness = [10.0e-9, 200.0e-9]
metal_min_y = [4e-6, 4e-6 + metal_thickness[0]]

# 4. Waveguide Dimensions
wg_width = 1.2e-6
wg_thickness = 0.2e-6

# 4.1 Bend Waveguide at the center of the simualation ?
bend_waveguide = False
bend_radius = 25e-6
bend_orientation = 0

# 5. Box Layer Thickness
box_thickness = 6.0e-6


# 6. Substrate Layer Thickness
sub_thickness = 5e-6
