...
from MODE.disk_waveguide.user_inputs.user_sweep_parameters import *    
...
path_to_write = ["MODE\\Results\\disk_waveguide\\Figures\\sweep_height",
"MODE\\Results\\disk_waveguide\\lumerical_files\\sweep_height"]
...
for wd in range(0,len(wg_height_array)):
    ...
    # Save the file
    file_name_mode = os.path.join(directory_to_write[1], "disk_mode_height_sweep_" + str(wd) + ".lms")
