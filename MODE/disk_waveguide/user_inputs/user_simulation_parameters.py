...
presented below.
     ...
     clad_max_y    <---------------------------------------------->                                                   
          ------ ^ +----------------------------------------------+                                                   
                   ...
                   ||                 waveguide | |              || |                                                 
     clad_min_y    ||                           | v              || |                                                 
          ------ ^ +|___________________________+----------------|+ | simulation_span_y                               
  box_thickness  | ||                    Box                     || |                                                 
          ------ v +|--------------------------------------------|+ |                                                 
                 ^ ||                                            || |                                                 
                 | ||                               FDE region   || |                                                 
...
3. The disk waveguide thickness.
...
bend_waveguide = True    # Let this enabled 
bend_radius = 5e-6
bend_orientation = 0
