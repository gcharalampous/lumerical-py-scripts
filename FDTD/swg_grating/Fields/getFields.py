...
def getFields(fdtd):
    ...
    path_to_write = ["FDTD\\Results\\swg_grating\\Figures\\fields"]
...
# ---------------------------------------------------------------------------
    ...
    return x,y,z,field_xy, field_xz, directory_to_write
...
if(__name__=="__main__"):
    with lumapi.FDTD() as fdtd:
        ...
        x,y,z,E_xy,E_xz, directory_to_write = getFields(fdtd=fdtd)
...
# --------------------------------Top-View---------------------------------
        ...
        plt.tight_layout()
        file_name_plot = os.path.join(directory_to_write[0], "E_profile_xy.png")
...
# --------------------------------Side-View---------------------------------
        ...
        plt.tight_layout()
        file_name_plot = os.path.join(directory_to_write[0], "E_profile_xz.png")
        plt.savefig(file_name_plot)
