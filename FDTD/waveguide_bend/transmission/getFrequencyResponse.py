...
of the waveguide bend structure defined in the circular_bend.fsp or
euler_bend.fsp file from the T_exp monitor. The back reflection from
the source is also printed.
