...
def getCouplingResponse(fdtd):
    ...
    width_grating = np.squeeze(
        fdtd.getsweepresult("sweep_taper_width", "transmission").get("width_grating")
    )
...
def plot_max_transmission_at_wavelength(
    T, wavelength, width_grating, target_wavelength, output_path
):
    """
...
if __name__ == "__main__":
    try:
        ...
        with lumapi.FDTD(str(template_fsp)) as fdtd:
            ...
            plot_max_transmission_at_wavelength(
                T, wavelength, width_grating, target_wavelength, file_name_plot
            )
