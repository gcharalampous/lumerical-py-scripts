...
wg_width_start = 0.5e-6     # Choose the start waveguide width 'wg_width_start' you want to start sweeping
wg_width_stop = 3.0e-6      # Choose the stop waveguide width 'wg_width_stop' you want to finish sweeping
